...
public class Xpath {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //driver.findElement(By.xpath("//button[text()='Add Element']")).click();   bu durumda da calısır
        //driver.findElement(By.xpath("//*[text()='Add Element']")).click();        bu durumda da calısır
